  ...
  function renderCards() {
    ...
    cardsToShow.forEach((card, i) => {
      ...
      cardEl.innerHTML = `
        ...
        <img class="swipe-card-image" src="${card.image}" alt="${card.title}" loading="${imgLoading}" ${imgFetchPriority} decoding="async" onerror="this.onerror=null;this.src='/images/6243807090316203124aee66_placeholder-image.svg'">
        ${vendorOverlay}
