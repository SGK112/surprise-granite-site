...
const PUBLIC_SPEC_KEYS = new Set([
  ...
  // the pattern that keeps a retired colour live for SEO — showed no banner and
  // read as orderable. Not sensitive: it is meant to be shown to the customer.
  'discontinued', 'discontinued_reason',
]);
