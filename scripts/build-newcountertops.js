...
(function(){
  ...
  var STEPS = [
    { el: sections,  title: 'Measure your counters', sub: 'Length and depth of each run. Rough numbers are fine.' },
    { el: grids[0],  title: 'Material and service',  sub: 'What you want, and how much of the work is ours.' },
  ...
  function draw(){
    ...
    nav.querySelector('.nc-back').style.visibility = i ? 'visible' : 'hidden';
