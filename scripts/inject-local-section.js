...
<section style="background:#f8f9fa;padding:64px 20px;border-top:1px solid #e5e5e5;font-family:'Inter',system-ui,sans-serif;">
  <div style="max-width:1100px;margin:0 auto;">
    <div style="text-align:center;margin-bottom:28px;">
      ...
      <p style="color:#555;max-width:760px;margin:0 auto;line-height:1.7;">${angle} Family-owned and based in Surprise, we serve the entire West Valley and greater Phoenix &mdash; licensed Arizona General Contractor ROC#367593, free in-home estimates.</p>
    </div>
