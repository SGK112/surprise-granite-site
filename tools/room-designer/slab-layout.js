...
(function(window) {
  ...
  window.SlabLayout = {
    ...
    showSourceTab: function() { if (typeof showToast === 'function') showToast('Source tab: use the Materials panel to select slab material', 'info'); },
    searchInventory: function() { if (typeof showToast === 'function') showToast('Inventory search: browse slabs at surprisegranite.com/marketplace/slabs/', 'info'); },
    selectInventorySlab: function() { if (typeof showToast === 'function') showToast('Select a slab from the Materials panel first', 'info'); },
    toggleAutoSeams: function() { state.autoSeams = !state.autoSeams; if (typeof showToast === 'function') showToast('Auto-seams: ' + (state.autoSeams ? 'ON' : 'OFF'), 'info'); },
    getState: () => ({ ...state }),
